...
const commitFile = () => __awaiter(void 0, void 0, void 0, function* () {
    yield (0, exports.execCmd)('git', ['config', '--global', 'user.email', 'baejeu@naver.com']);
    yield (0, exports.execCmd)('git', ['config', '--global', 'user.name', '배제우']);
    yield (0, exports.execCmd)('git', ['add', "."]);
    yield (0, exports.execCmd)('git', ['commit', '-m', '깃허브의 프로그래머스 순위를 나타내는 지표를 제공합니다.']);
